...
type RoleCards struct {
	...
	QaMeticulous   uint        `json:"qaMeticulous"   orm:"qa_meticulous"   description:"QA Meticulousness (0-100)"`  // QA Meticulousness (0-100)
	QaDeception    uint        `json:"qaDeception"    orm:"qa_deception"    description:"QA Deception (0-100)"`       // QA Deception (0-100)
	QaVigor        uint        `json:"qaVigor"        orm:"qa_vigor"        description:"QA Vigor (0-100)"`           // QA Vigor (0-100)
	QaEmpathy      uint        `json:"qaEmpathy"      orm:"qa_empathy"      description:"QA Empathy (0-100)"`         // QA Empathy (0-100)
	QaInitiative   uint        `json:"qaInitiative"   orm:"qa_initiative"   description:"QA Initiative (0-100)"`      // QA Initiative (0-100)
	QaResilience   uint        `json:"qaResilience"   orm:"qa_resilience"   description:"QA Resilience (0-100)"`      // QA Resilience (0-100)
	QaPresence     uint        `json:"qaPresence"     orm:"qa_presence"     description:"QA Presence (0-100)"`        // QA Presence (0-100)
	QaProfessional uint        `json:"qaProfessional" orm:"qa_professional" description:"QA Professionalism (0-100)"` // QA Professionalism (0-100)
