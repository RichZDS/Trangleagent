...
type UserViewParams struct {
	...
	RealityRole  string `json:"realityRole"  orm:"reality_role"   description:"现实身份/角色"`
	AbnormalRole string `json:"abnormalRole" orm:"abnormal_role"  description:"异常身份/角色"`
	JobTitle     string `json:"jobTitle"     orm:"job_title"      description:"职位"`
	ActiveRoleId  uint64      `json:"activeRoleId"  orm:"active_role_id"   description:"当前选中的角色卡ID"`
	Exp           uint        `json:"exp"           orm:"exp"             description:"经验值"`
	Level         uint        `json:"level"         orm:"level"            description:"等级"`
