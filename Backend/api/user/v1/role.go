...
type RoleCreateReq struct {
	...
	QaMeticulous  uint   `json:"qaMeticulous"   description:"素质保障-细致(0-100)"`
	QaDeception   uint   `json:"qaDeception"    description:"素质保障-欺瞒(0-100)"`
	QaVigor       uint   `json:"qaVigor"        description:"素质保障-活力(0-100)"`
	QaEmpathy     uint   `json:"qaEmpathy"      description:"素质保障-共情(0-100)"`
	QaInitiative  uint   `json:"qaInitiative"   description:"素质保障-主动性(0-100)"`
	QaResilience  uint   `json:"qaResilience"   description:"素质保障-韧性(0-100)"`
	QaPresence    uint   `json:"qaPresence"     description:"素质保障-气场(0-100)"`
	QaProfessional uint  `json:"qaProfessional" description:"素质保障-专业性(0-100)"`
	QaDiscretion  uint   `json:"qaDiscretion"   description:"素质保障-谨慎(0-100)"`
}
